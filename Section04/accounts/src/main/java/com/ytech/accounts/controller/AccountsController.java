package com.ytech.accounts.controller;
...
import com.ytech.accounts.dto.ResponseDto;
...
@AllArgsConstructor
@Validated
@Tag(name = "CRUD REST APIs for Accounts in EazyBank", description = "CRUD REST APIs in EazyBank to CREATE, UPDATE, FETCH, AND DELETE accounts details")
